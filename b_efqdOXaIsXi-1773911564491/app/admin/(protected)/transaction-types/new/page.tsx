...
export default function AdminNewTransactionTypePage() {
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
        <div>
          <p className="text-xs uppercase tracking-[0.25em] text-muted-foreground">Taxonomy</p>
          <h1 className="mt-2 font-serif text-3xl text-foreground">Add transaction type</h1>
        </div>
        <Link
      ...
      <TaxonomyForm mode="transaction" mediaAssets={getMediaAssets()} />
    </div>
  );
}
